...
<body>
    ...
    <div class="container">
        ...
        <ul>
            <li><b>/user-crud/api.php/register</b> - Register a new user</li>
            <li><b>/user-crud/api.php/login</b> - Login to the system</li>
            <li><b>/user-crud/api.php/profile</b> - View your profile (requires authentication)</li>
